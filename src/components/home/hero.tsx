...
export function Hero() {
  return (
    <section className="relative flex min-h-[100svh] items-center overflow-hidden bg-[#304FFD]">
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-[#304FFD]/75" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#304FFD] via-[#304FFD]/80 to-[#304FFD]" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#304FFD] via-[#304FFD]/70 to-transparent" />
      </div>

      <div className="spectrum-bar absolute inset-x-0 top-0 z-[1] h-[3px]" />
      <div
        aria-hidden
        className="pointer-events-none absolute left-[-10%] top-[15%] h-[50%] w-[45%] rounded-full bg-white/15 blur-[100px]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute bottom-[10%] right-[-5%] h-[40%] w-[40%] rounded-full bg-white/10 blur-[100px]"
      />
          ...
          <div className="lg:col-span-7 xl:col-span-8">
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1.5 flex flex-wrap items-center gap-x-2 gap-y-1 text-[10px] font-semibold uppercase tracking-[0.28em] text-white/70 sm:text-xs sm:tracking-[0.35em]">
            ...
            >
              {hosts.map((h) => (
                <span
                  key={h.code}
                  className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/10 px-3 py-1.5 backdrop-blur-md"
                >
                  <img
            ...
            >
              ...
              <br />
              <span className="text-white">football show</span>
            ...
            <motion.p
              ...
              className="mt-5 max-w-xl text-[0.95rem] leading-relaxed text-white/75 sm:mt-6 sm:text-lg"
            >
            ...
            >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="w-full border-white/40 bg-transparent text-white hover:border-white hover:bg-white hover:text-[#304FFD] sm:w-auto"
              >
                <Link href="/groups">
          ...
          >
            <div className="spectrum-frame">
              <div className="spectrum-frame-inner p-4 sm:p-5">
                ...
                <div className="mt-5 grid grid-cols-3 gap-2 border-t border-white/15 pt-4 sm:gap-3">
                  {stats.map((s) => (
                    <div key={s.label} className="text-center">
                      <p className="font-display text-2xl leading-none text-white sm:text-3xl">{s.value}</p>
                      <p className="mt-1.5 text-[9px] uppercase tracking-[0.2em] text-white/50 sm:text-[10px]">
                        {s.label}
                      </p>
                    </div>
                  ))}
            ...
            <p className="mt-4 hidden text-center text-[10px] uppercase tracking-[0.25em] text-white/45 lg:block">
